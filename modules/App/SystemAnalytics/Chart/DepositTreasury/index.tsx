...
import { getRevenueList, getRevenueTotal, getViewsList, getViewsTotal, getWatchTimeList, getWatchTimeTotal } from "@/common/api/history";
...
const DepositTreasuryChart = () => {
  ...
  return (
    <div id="Deposit&Treasury" className="overview chart text-base app">
      <Analystics
        totalDeposit={views}
        watchTime={watchTime}
        lastViews={lastViews}
      ...
      {activeTab === 0 ?
      (<Chart
        dataChartDeposit={dataChartViews}
        activeTab={activeTab}
