  ...
  return (
    <div className="md:w-full w-max app">
      ...
      <div className="list-collapse">
        <div className="date mb-4 font-bold">Ongoing Withdraw</div>
          ...
          <div key={index} className="collapse-list">
            <Collapse className="bg-white mb-5 app" expandIconPosition="end">
              <Panel
                ...
                header={<p>Withdraw ID: {item.depositIdStr}</p>}
                key="1"
              >
                <Descriptions className="app" column={1}>
                  <Descriptions.Item label="Withdraw Amount">{item.depositAmount.toLocaleString("en-US")} VND</Descriptions.Item>
                  <Descriptions.Item label="Recipient Address">{item.receivedSofin} SF</Descriptions.Item>
                </Descriptions>
